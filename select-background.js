var backgrounds = ["https://lh5.googleusercontent.com/-IK3ojNLAfAI/URROqpcu-SI/AAAAAAAALD8/BGdxdC9u2pI/s2560/PescaderoBench.jpg",
...
var randomImageUrl = backgrounds[Math.floor(Math.random() * backgrounds.length)];

var bgImg = document.querySelector('#background-picture');
bgImg.src = randomImageUrl;
